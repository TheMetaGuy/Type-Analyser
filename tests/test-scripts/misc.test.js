import { hasCircularReference, isJSONSerializable, extendedTypeOf } from '../testIndex.js';
...
it('should return false forDataView', () => {
    let obj = { key: new DataView(new ArrayBuffer(8)) };
    expect(isJSONSerializable(obj)).toBe(false);
    expect(isJSONSerializable(obj,true)).toBe(false);
});

it('should return false for SharedArryBuffer', () => {    
...
it('should return false for array with non integer properties', () => {
    let arr =[1, 2, 3, 4];
    arr.foo = "bar"; 
...
it(' should return TRUE where objects inherits properties from a prototype', () => {
...
it('should handle ES5 type Symbol polyfill', () => {
...
it('return false for deeply nested function', () => {
    const obj = {
        level1: {
...
it('should handle deeply nested Date', () => {
    const obj = {
        level1: {
...
it('return false for deeply nested RegExp', () => {
    const obj = {
        level1: {
...
it('should return false for URL unless "acceptFormatLoss" param set', () => {
    let obj = { key: new URL('http://example.com') };
    expect(isJSONSerializable(obj)).toBe(false);
    expect(isJSONSerializable(obj,true)).toBe(true);
});

it('should return false for URLSearchParams unless "acceptFormatLoss" param set', () => {
    let obj = { key: new URLSearchParams('name=Jonathan') };
    expect(isJSONSerializable(obj)).toBe(false);
    expect(isJSONSerializable(obj,true)).toBe(true);
});

it('should return false for Int8Array unless "acceptFormatLoss" param set', () => {
    let obj = { key: new Int8Array([1, 2, 3, 4]) };
    expect(isJSONSerializable(obj)).toBe(false);
    expect(isJSONSerializable(obj,true)).toBe(true);
});

it('should return false for Uint8Array unless "acceptFormatLoss" param set', () => {
    let obj = { key: new Uint8Array([1, 2, 3, 4]) };
    expect(isJSONSerializable(obj)).toBe(false);
    expect(isJSONSerializable(obj,true)).toBe(true);
});

it('should return false for Uint8ClampedArray unless "acceptFormatLoss" param set', () => {
    let obj = { key: new Uint8ClampedArray([1, 2, 3, 4]) };
    expect(isJSONSerializable(obj)).toBe(false);
    expect(isJSONSerializable(obj,true)).toBe(true);
});

it('should return false for Int16Array unless "acceptFormatLoss" param set', () => {
    let obj = { key: new Int16Array([1, 2, 3, 4]) };
    expect(isJSONSerializable(obj)).toBe(false);
    expect(isJSONSerializable(obj,true)).toBe(true);
});

it('should return false for Uint16Array unless "acceptFormatLoss" param set', () => {
    let obj = { key: new Uint16Array([1, 2, 3, 4]) };
    expect(isJSONSerializable(obj)).toBe(false);
    expect(isJSONSerializable(obj,true)).toBe(true);
});

it('should return false for Int32Array unless "acceptFormatLoss" param set', () => {
    let obj = { key: new Int32Array([1, 2, 3, 4]) };
    expect(isJSONSerializable(obj)).toBe(false);
    expect(isJSONSerializable(obj,true)).toBe(true);
});

it('should return false for Uint32Array unless "acceptFormatLoss" param set', () => {
    let obj = { key: new Uint32Array([1, 2, 3, 4]) };
    expect(isJSONSerializable(obj)).toBe(false);
    expect(isJSONSerializable(obj,true)).toBe(true);
});

it('should return false for Float32Array unless "acceptFormatLoss" param set', () => {
    let obj = { key: new Float32Array([1.1, 2.2, 3.3, 4.4]) };
    expect(isJSONSerializable(obj)).toBe(false);
    expect(isJSONSerializable(obj,true)).toBe(true);
});

it('should return false for Float64Array unless "acceptFormatLoss" param set', () => {
...
it('return false for object with no circular references', () => {
